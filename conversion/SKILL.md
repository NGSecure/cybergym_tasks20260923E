...
> **This repo (cybergym_tasks20260923E).** The prime bundles live under
> `cybergym_tasks20260923E/`, and the conversion toolkit is a self-contained copy under
...
From the `cybergym_tasks20260923E/` directory (where the bundles are):

```bash
cd cybergym_tasks20260923E
# one bundle
